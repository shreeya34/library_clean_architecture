...
from modules.interfaces.response.admin_response import BookViewResponse, BookAvailabilityResponse
...
class ViewBooksUseCase:
    ...
    def execute(self, db: Session, title: str = "") -> dict:
        books = (
            ...
            if title else self.admin_repo.get_all_books(db)
        )
        ...
        for book in books:
            ...
            if is_available:
                result.append(BookAvailabilityResponse(
